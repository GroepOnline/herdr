class OnlinechefgroepHerdr < Formula
  ...
  on_linux do
    ...
    on_arm do
      url "https://github.com/OnlineChefGroep/herdr/releases/download/v0.7.6/herdr-linux-aarch64"
  ...
  on_macos do
    on_intel do
      url "https://github.com/OnlineChefGroep/herdr/releases/download/v0.7.6/herdr-macos-x86_64"
      sha256 "6347f7bf567d48a7617ff6c6b9f8d5ca13fe9b492ccd30ca4fda4c5a34a41dff"
    end
    on_arm do
      url "https://github.com/OnlineChefGroep/herdr/releases/download/v0.7.6/herdr-macos-aarch64"
