...
use super::{
    ...
    MASTRACODE_REMOVED_HOOK_EVENTS, OPENCODE_TUI_PLUGIN_ASSET, OPENCODE_TUI_PLUGIN_INSTALL_NAME,
    OPENCODE_TUI_PLUGIN_SPEC, QWEN_HOOK_ASSET, QWEN_HOOK_EVENTS, QWEN_HOOK_INSTALL_NAME,
};
