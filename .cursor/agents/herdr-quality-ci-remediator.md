...
3. Inspect `gh run view <run_id> --repo GroepOnline/herdr --log-failed` and the sticky `<!-- herdr-quality-remediation -->` comment.
...
7. Validate with `gh pr checks <pr> --repo GroepOnline/herdr --watch`.
