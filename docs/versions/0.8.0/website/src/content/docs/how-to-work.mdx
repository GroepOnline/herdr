...
On iPhone, apps like [Moshi](https://getmoshi.app/) work well. See
[Moshi (iPhone) with Herdr](/docs/moshi/) and
[Fleet ops and gateway](/docs/fleet-ops/) when many hosts are online.
