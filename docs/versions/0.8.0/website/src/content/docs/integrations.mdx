---
title: Integrations
description: Install Herdr integrations for Pi, OMP, Claude Code, Codex, GitHub Copilot CLI, Devin CLI, Droid, Kimi Code CLI, OpenCode, Kilo Code CLI, Hermes Agent, Qoder CLI, Cursor Agent CLI, MastraCode, Grok CLI, Command Code, and Freebuff.
---
...
herdr integration install freebuff
```
...
| Session identity | Claude Code, Codex, GitHub Copilot CLI, Devin CLI, Droid, Qoder CLI, Cursor Agent CLI, Grok CLI, Command Code, Freebuff | The integration reports native session references for restore. State still comes from Herdr's screen manifest detection. |
...
k or plugin was installed for the same user account.
