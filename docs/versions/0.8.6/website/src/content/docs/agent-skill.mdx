...
Herdr ships a reusable agent skill file at [`SKILL.md`](https://github.com/GroepOnline/herdr/blob/main/SKILL.md).
...
```text
https://github.com/GroepOnline/herdr/blob/main/SKILL.md
```
...
[Open `SKILL.md` on GitHub →](https://github.com/GroepOnline/herdr/blob/main/SKILL.md)
