...
Herdr 提供了一个可复用的智能体技能文件: [`SKILL.md`](https://github.com/GroepOnline/herdr/blob/main/SKILL.md)。
...
[在 GitHub 上打开 `SKILL.md` →](https://github.com/GroepOnline/herdr/blob/main/SKILL.md)
